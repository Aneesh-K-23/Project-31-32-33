...
function setup() {
  ...
  zombies = createSprite(width/2, height -100, 50, 50);
  zombies.addAnimation("lefttoright", zombie1, zombie2, zombie1);
  zombies.addAnimation("righttoleft", zombie3, zombie4, zombie3);
  zombies.addImage("sad", sadzombie);
